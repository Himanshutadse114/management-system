...
export default function ReportsWorkspace({ token, access }) {
  ...
  const [history,setHistory]=useState([]);const[busy,setBusy]=useState(false);const[downloading,setDownloading]=useState('');const[error,setError]=useState('');const[notice,setNotice]=useState('');const[tab,setTab]=useState('Create');
  ...
  return <div className="reports-page">
    ...
    {tab==='Create' && <div className="reports-layout">
